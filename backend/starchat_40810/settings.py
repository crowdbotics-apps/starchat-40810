"""
Django settings for starchat_40810 project.
...
ROOT_URLCONF = 'starchat_40810.urls'
...
WSGI_APPLICATION = 'starchat_40810.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "starchat_40810 API",
    "DESCRIPTION": "API documentation for starchat_40810 App",
    "VERSION": "v1",
}
